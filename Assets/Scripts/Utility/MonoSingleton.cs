...
public class MonoSingleton<T> : MonoBehaviour where T : Component
{
    ...
    public static T Instance
    {
        get
        {
            if (!InstanceExists && !isQuitting)
                FindOrCreateInstance();
            return instance;
        }
    }
    public static bool InstanceExists { get { return instance != null; } } //allows checks to see if instance exists without creating new instance if null
